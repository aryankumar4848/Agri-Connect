...
function App() {
  ...
  useEffect(() => {
    fetch(`${process.env.REACT_APP_BACKEND_URL}/Market`)
      .then(res => res.json())
      .then(data => setProdData(data))
      .catch(err => console.log("Error: ", err))


    fetch(`${process.env.REACT_APP_BACKEND_URL}/crops`)
      .then(res => res.json())
    ...
    <Router>
      <div className="App">
        ...
        <Routes>
          ...
          <Route exact path='/transaction' element={<TransactionStatus data={buyDetails} />}></Route>
